...
$insights               = $midonet_settings['mem_use_insights']
...
class {'::midonet::cluster':
  ...
  analytics_ip         => $midonet_settings['mem_override_servername']? {'' => $ana_public_ip , default => $midonet_settings['mem_override_servername']}
}
